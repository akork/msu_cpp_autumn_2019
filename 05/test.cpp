...
int main()
{
    ...
    auto s4_2 = std::stringstream("1. true 3");
    Deserializer d4_2(s4_2);
    checkTrue(d4_2.load(y) == Error::CorruptedArchive);

    auto s4_3 = std::stringstream("1wtstms true 3");
    Deserializer d4_3(s4_3);
    checkTrue(d4_3.load(y) == Error::CorruptedArchive);
